...
## Overview
- **Target file:** `src/components/sites/reference-site/features-de335934/FeaturesHero.tsx`
- **Screenshot:** `docs/design-references/reference-site/features-de335934/01-hero.jpg`
