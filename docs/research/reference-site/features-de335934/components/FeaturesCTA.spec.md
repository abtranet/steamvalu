...
## Overview
- **Target file:** `src/components/sites/reference-site/features-de335934/FeaturesCTA.tsx`
- **Screenshot:** `docs/design-references/reference-site/features-de335934/05-cta-footer.jpg`
...
- Buttons: "Try for free" (links to `https://calendly.com/d/crvw-993-zd8/reference site-trial-setup-call-30-days-free?utm_content=try_for_free`, new tab), "Book Demo" (links to `https://calendly.com/d/cr2r-cbx-n66/reference site-introduction?utm_content=reference site_introduction`, new tab)
