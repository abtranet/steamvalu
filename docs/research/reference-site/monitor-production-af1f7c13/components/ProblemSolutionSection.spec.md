...
## Overview
- **Target file:** `src/components/sites/reference-site/monitor-production-af1f7c13/ProblemSolutionSection.tsx`
- **Screenshot:** `docs/design-references/reference-site/monitor-production-af1f7c13/desktop-02-hero-visual-problem.jpg`
