...
## Overview
- **Target file:** `src/components/sites/reference-site/monitor-production-af1f7c13/StatsSection.tsx`
- **Screenshot:** `docs/design-references/reference-site/monitor-production-af1f7c13/desktop-03-cta-stats.jpg`, `desktop-04-stats-cta2.jpg`
