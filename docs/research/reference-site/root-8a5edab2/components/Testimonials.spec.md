...
1. "After the pilot phase, we performed installation throughout the entire plant. Reference site has proved to be a flexible partner and has provided us with services that would not be possible to implement through manpower." — Igor Leskanic, Plastic Omnium Auto Exteriors
2. "IPS is one of the solutions that will, in our opinion, build the big future of facility management. Thanks to reference site, we now have a flexible and reliable partner that managed to implement IPS solution based on our requirements. After offices in Bratislava, we will jointly implement IPS also in other branches." — Karol Michaliak, HB Reavis, Data & Application Teamleader
