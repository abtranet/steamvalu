...
## Overview
- **Target file:** `src/components/sites/twinzo-com-ca6666c1/features-de335934/FeatureCardsGrid.tsx`
- **Screenshot:** `docs/design-references/twinzo-com-ca6666c1/features-de335934/02-cards-1.jpg`, `03-cards-2-support.jpg`
...
- background-image: one of `card-bg-1.jpg` / `card-bg-2.jpg` /
  ...
  `public/sites/twinzo-com-ca6666c1/features-de335934/images/`)
...
## Assets
- `public/sites/twinzo-com-ca6666c1/features-de335934/images/card-bg-1.jpg` (1416×1688)
