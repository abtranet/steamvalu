...
## Overview
- **Target file:** `src/components/sites/twinzo-com-ca6666c1/features-de335934/SupportedDataSources.tsx`
- **Screenshot:** `docs/design-references/twinzo-com-ca6666c1/features-de335934/03-cards-2-support.jpg`, `04-support-coming.jpg`
...
3. **BLE RTLS** — Quuppa, Zebra, Twinzo proprietary
4. **Man down solution** — Quuppa, Twinzo proprietary
5. **Open source multiplatform middleware** — (no sub-items; label only)
6. **AI-based camera feed twinzo RTLS** — (no sub-items; label only)

Header text (verbatim):
- "Supported external data sources"
- "General API available for any data-source"
- "More about REST API" → links to `https://twinzo.atlassian.net/wiki/spaces/PUBD/pages/73170950/REST+API` (external, new tab)
