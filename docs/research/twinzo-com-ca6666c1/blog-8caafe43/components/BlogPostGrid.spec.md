...
## Overview
- **Target files:**
  - `src/components/sites/twinzo-com-ca6666c1/blog-8caafe43/BlogPostGrid.tsx`
    (grid wrapper, maps over post data)
  - `src/components/sites/twinzo-com-ca6666c1/blog-8caafe43/BlogPostCard.tsx`
    (single card — image, title, excerpt, date, button)
  - `src/components/sites/twinzo-com-ca6666c1/blog-8caafe43/data.ts`
    (typed array of the 37 real posts scraped from the live site)
- **Screenshot:** `docs/design-references/twinzo-com-ca6666c1/blog-8caafe43/live-card-grid-800w.jpg`
...
`docs/research/twinzo-com-ca6666c1/blog-8caafe43/posts-data-reference.json`
...
- 37 thumbnail images downloaded to
  `public/sites/twinzo-com-ca6666c1/blog-8caafe43/images/<file>` — referenced
  in `data.ts` as `/sites/twinzo-com-ca6666c1/blog-8caafe43/images/<file>`.
