...
Source: https://www.twinzo.com/blog
site-key: `twinzo-com-ca6666c1` · page-key: `blog-8caafe43`
...
- Card grid content: real posts scraped from the live site's server-rendered
  HTML (37 posts, from "On-Premise twinzo on an Air-Gapped Plant Network"
  dated August 30, 2026 down to "Pushing the Boundaries" dated May 3, 2024).
  All 37 thumbnail images were downloaded into
  `public/sites/twinzo-com-ca6666c1/blog-8caafe43/images/`.
- Post links point to `/blog-post/<slug>` on the live site. Per the parent
  ...
  preserve the semantic reference by linking to `https://www.twinzo.com` +
