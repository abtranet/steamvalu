...
- Buttons:
  - "Try for free" — `href="https://calendly.com/d/crvw-993-zd8/twinzo-trial-setup-call-30-days-free?utm_content=try_for_free"`, opens new tab, white outline pill (`btn.btn-try-for-free.cc-secondary`).
  - "Book Demo" — `href="https://calendly.com/d/cr2r-cbx-n66/twinzo-introduction?utm_content=twinzo_introduction"`, opens new tab, filled brand-green pill (`btn`, default/primary style — same visual as header's primary CTA).
...
- Reuse whatever Button/pill component pattern the shared Header already established for "Try for free" / "Book Demo" (check `src/components/sites/twinzo-com-ca6666c1/shared/Header.tsx` for the exact classes before writing new ones, to stay visually consistent with the nav's own CTA buttons).
