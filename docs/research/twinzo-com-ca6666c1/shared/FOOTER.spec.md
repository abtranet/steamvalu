...
## Overview
- Target file: `src/components/sites/twinzo-com-ca6666c1/shared/Footer.tsx`
...
- Column heading (e.g. "Use cases", "Twinzo", "Resources", "Links"): `color: white`, `font-size: 18px`, `font-weight: 500`, at ~50% opacity wrapper (`u-opacity50`)
...
footer (bg black)
  ...
  4 columns:
    ...
    3. "Resources" (external links, each with a small up-right arrow icon at 50% opacity)
       - Customers portal -> https://partner.twinzo.eu/
       - Partners portal -> https://partner.twinzo.eu/
       - Documentation -> https://twinzo.atlassian.net/wiki/spaces/PUBD/overview
       - Helpdesk -> https://partner.twinzo.eu/helpdesk/customer-care-1
       - Sign In -> https://platform.twinzo.com/login
    4. "Links"
       - LinkedIn -> https://www.linkedin.com/company/twinzo
       - YouTube -> https://www.youtube.com/@twinzo-digitaltwin
  ...
  Bottom row (50% opacity):
    - Left column: "© Twinzo 2026" + "Cookie Settings" link (opens cookie preferences — stub as no-op button)
    - Right column: paragraph — "Through collaborative efforts with our inaugural customers, we've systematically devised an expanding suite of solutions aimed at addressing commonplace challenges in manufacturing. Our relentless pursuit pivots towards an intensified emphasis on the tridimensional visualization paradigm. In 2019, this dedicated initiative bore fruit in the form of 'twinzo'—a groundbreaking 3D live digital twin, seamlessly operational on any device."
```

## Assets
- Footer logo: same twinzo wordmark SVG as header, `fill="white"` (viewBox `0 0 80 20`)
- App badges: downloaded to `public/sites/twinzo-com-ca6666c1/shared/images/badges/{app-store,google-play,windows}.svg`
