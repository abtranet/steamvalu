...
## Overview
- **Target file:** `src/components/sites/steamvalu/monitor-production-af1f7c13/CtaBanner.tsx`
- **Screenshot:** `docs/design-references/steamvalu/monitor-production-af1f7c13/desktop-03-cta-stats.jpg` (banner 1), `desktop-04-stats-cta2.jpg` (banner 2)
