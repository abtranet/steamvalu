...
## Overview
- **Target file:** `src/components/sites/steamvalu/monitor-production-af1f7c13/RelatedUseCases.tsx`
- **Screenshot:** `docs/design-references/steamvalu/monitor-production-af1f7c13/desktop-05-related.jpg`
...
## Assets
- `public/sites/steamvalu/monitor-production-af1f7c13/images/production-monitoring.jpg` (424×424 JPEG) — card 1, links to `/material-order-automation`
- `public/sites/steamvalu/monitor-production-af1f7c13/images/logistics-optimization.jpg` (424×424 JPEG) — card 2, links to `/optimize-internal-logistics`
