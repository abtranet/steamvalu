...
## Overview
- **Target file:** `src/components/sites/steamvalu/monitor-production-af1f7c13/HeroSection.tsx`
- **Screenshot:** `docs/design-references/steamvalu/monitor-production-af1f7c13/desktop-01-hero.jpg`, `desktop-02-hero-visual-problem.jpg`
...
## Assets
- `public/sites/steamvalu/monitor-production-af1f7c13/images/phone-mockup-horizontal.png` (1819×897 PNG, device frame with transparent screen)
