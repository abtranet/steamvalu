...
**Scroll sweep:** Loaded the live page in Chrome (1440×900 viewport) and scrolled slowly from top to bottom in ~6 steps, screenshotting at each step (saved to `docs/design-references/steamvalu/monitor-production-af1f7c13/desktop-0*.jpg`). Observations:
