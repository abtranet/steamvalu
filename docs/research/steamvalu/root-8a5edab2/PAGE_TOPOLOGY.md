...
Full raw HTML saved for reference during build: fetched via `curl` (see section extracts below); screenshots in `docs/design-references/steamvalu/root-8a5edab2/`.
...
## Assets referenced (downloaded to `public/sites/steamvalu/root-8a5edab2/`)
