...
- Paragraph (grey `#808080`, `paragraph-18`): "It's simple. To see all the possibilities, go to the App Store or Google Play and download the \"twinzo—digital twin\" app."
