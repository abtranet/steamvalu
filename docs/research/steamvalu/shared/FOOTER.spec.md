...
## Overview
- Target file: `src/components/sites/steamvalu/shared/Footer.tsx`
...
- App badges: downloaded to `public/sites/steamvalu/shared/images/badges/{app-store,google-play,windows}.svg`
