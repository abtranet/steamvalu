      ...
      <div className="mx-auto max-w-[1132px] px-6 md:px-10">
        ...
        <div className="mt-20 max-w-[760px] md:mt-24">
          ...
          <div className="flex flex-col gap-4 text-foreground/60">
            <p>
              twinzo is a live 3D digital twin of your facility. It combines
            ...
            <p>
              Connect the systems you already run, or deploy twinzo RTLS.
          ...
          <div className="flex flex-col gap-4 text-foreground/60">
            ...
            <p>
              Manage: Recognize risks in time. twinzo&apos;s digital twin
