import { CheckIcon } from "@/components/sites/twinzo-com-ca6666c1/shared/icons";
...
const CARDS: FeatureCard[] = [
  {
    ...
    align: "bottom",
    bgClasses:
      "bg-top bg-[url('/sites/twinzo-com-ca6666c1/features-de335934/images/card-bg-2-re.jpg')] sm:bg-[url('/sites/twinzo-com-ca6666c1/features-de335934/images/card-bg-2.jpg')]",
  },
  {
    title: "Data analysis",
    items: [
    ...
    align: "top",
    bgClasses:
      "bg-bottom bg-[url('/sites/twinzo-com-ca6666c1/features-de335934/images/card-bg-1.jpg')]",
  },
  {
    ...
    align: "top",
    bgClasses:
      "bg-bottom bg-[url('/sites/twinzo-com-ca6666c1/features-de335934/images/card-bg-3.jpg')]",
  },
  {
    ...
    align: "bottom",
    bgClasses:
      "bg-top bg-[url('/sites/twinzo-com-ca6666c1/features-de335934/images/card-bg-4-re.jpg')] sm:bg-[url('/sites/twinzo-com-ca6666c1/features-de335934/images/card-bg-4.jpg')]",
  },
];
