const COLUMN_1 = [
  "Auditer — Choisir un système représentatif et documenter les sources, les actifs et les objectifs.",
  "Prototyper — Construire les jumeaux unitaires, leurs relations et une première vue composée."
];

const COLUMN_2 = [
  "Valider — Comparer le fonctionnement observé à une référence de départ et qualifier la valeur.",
  "Étendre — Déployer par ligne, zone ou site seulement lorsque les preuves soutiennent la décision."
];

export function ComingNext() {
  return (
    <section className="sv-next-steps">
