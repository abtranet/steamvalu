import { REST_API_DOCS_URL } from "@/lib/site";
import Link from "next/link";
import {
  CheckIcon,
  ChevronRightSmallIcon,
} from "@/components/sites/steamvalu/shared/icons";
...
const CATEGORIES: Category[] = [
  ...
  { label: "BLE RTLS", vendors: ["Quuppa", "Zebra", "SteamValu proprietary"] },
  { label: "Man down solution", vendors: ["Quuppa", "SteamValu proprietary"] },
  { label: "Open source multiplatform middleware", vendors: [] },
  { label: "AI-based camera feed SteamValu RTLS", vendors: [] },
];
