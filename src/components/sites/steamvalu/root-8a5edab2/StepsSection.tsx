...
const STEPS = [
  ...
  },
  {
    ...
    text: "Recognize risks in time. SteamValu's digital twin notification system lets you know about the coming dangers. Just set the parameter thresholds or special zones for your material ordering processes and act without delay.",
  },
];
