...
// Spec: docs/research/steamvalu/about-979bddc4/components/HistoryTimeline.spec.md
// Behavior: docs/research/steamvalu/about-979bddc4/BEHAVIORS.md (section 1)
//
...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    description:
      "Driving digital twin trends, SteamValu even accelerated its journey as an independent business.",
  },
  {
    year: "2023",
    label: "Investment announcement",
    description:
      "Consortium of Critical Ventures, Venture to Future Fund, Soulmates Ventures and Depo Ventures invested in SteamValu, recognizing its game-changing potential in smart manufacturing and beyond.",
  },
  {
    year: "2024",
