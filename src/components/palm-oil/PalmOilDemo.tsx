  ...
  return <div ref={shell} className={`${styles.shell} ${view === "dashboard" ? styles.dashboardShell : ""}`}>
    ...
    /> : <div className={styles.workspace}>
      <aside id="plant-explorer" className={`${styles.sidebar} ${leftOpen ? styles.sidebarOpen : ''}`}>
        ...
        <div className={styles.sidebarBottom}><span className={styles.eyebrow}>CHAÎNE DE TRANSFORMATION</span><strong className={styles.sidebarHeading}>Du régime à l’huile.</strong><p>Un seul environnement pour observer chaque étape du procédé.</p><div className={styles.siteMeta}><span><Box size={13} /> 7 unités</span><span><Activity size={13} /> Simulation locale</span></div></div>
